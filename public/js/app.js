              ...
              case 0:
                ...
                return fetch(URL, {
                  ...
                  if (resp.ok) {
                    ...
                    throw Error("Request rejected with status ".concat(resp.status));
                  }
                }).then(function (data) {
                  // Hide the form and display the post-subscribe DOM element
                  _this.submitted = data.status; // Clear the email string submitted by the user
...
var app = Vue.createApp(sendGridApp);
